...
export const COMMUNITY_MAPPING = {
  '西湖区': {
    '文教区': ['学军小学本部', '文三街小学', '文一街小学', '文澜中学', '保俶塔实验', '十三中'],
    '蒋村': ['绿城西溪诚园', '万科西庐', '绿城西溪融庄', '融创河滨之城', '中海西溪华府', '金地自在城', '滨江紫金府'],
    '申花': ['绿城沁园', '融创宜和园', '九龙仓碧玺', '滨江锦绣之城', '建发养云静舍', '华润幸福里', '绿城晓风印月', '滨江和品', '金茂府'],
    '三墩': ['万科融信西雅图', '龙湖水晶郦城', '越秀星汇城', '阳光城未来悦', '金地格林格林', '融创金成臻蓝府'],
    '之江': ['恒大水晶国际广场', '中海云宸', '宋城', '之江九里', '之江家园'],
    '留下': ['和家园', '西溪里', '翡翠城', '绿城桃花源'],
    '转塘': ['之江银泰城', '中天九溪诚品', '融科瑷骊山'],
  },
  '上城区': {
    '钱江新城': ['绿城蓝色钱江', '金色海岸', '阳光海岸', '万象城悦府', '绿城留香园', '融创涌清府', '信达滨江壹品', '绿城江河汇', '杭州壹号院'],
    '湖滨': ['湖滨银泰', '龙翔桥', '涌金门'],
    '望江': ['望江府', '融创侯潮府', '滨江金茂府', '望江新城', '新希望滨江锦粼府'],
    '南星桥': ['绿城春江花月', '金基晓庐', '阳光国际', '绿城之江一号', '信达外滩壹号'],
    '城东新城': ['万科大家世纪之光', '融创玖樟台', '滨江金色黎明', '龙湖天曜', '绿城杨柳郡'],
    '艮北新城': ['招商武林郡', '越秀亲爱里', '绿城杨柳郡东园', '滨江御虹府'],
  },
  '拱墅区': {
    '申花': ['绿城慧园', '欣盛东方福邸', '保利香槟国际', '滨江万家花城', '融信蓝孔雀', '龙湖天钜', '九龙仓珑玺'],
    '运河新城': ['融创金成臻蓝府', '绿都东澜府', '远洋心里', '德信大家运河云庄'],
    '祥符': ['万科杭行道', '越秀星汇尚城', '融创瑷颐湾', '大家漾山府'],
    '武林': ['武林壹号', '绿城兰园', '深蓝广场', '坤和中心'],
    '桃源': ['金辉贤林信步', '融创森与海', '绿都云和湖'],
    '丁桥': ['龙湖名景台', '远洋香奈', '万科城', '融信澜天'],
  },
  '滨江区': {
    '滨江区政府': ['东方郡', '江南实验学校', '绿城明月江南', '龙湖春江彼岸', '滨江金茂府', '中海寰宇天下', '信达中心|杭州壹号院'],
    '物联网小镇': ['滨江江南之星', '融创江南壹号院', '保利东湾', '世茂之西湖'],
    '彩虹城': ['彩虹城', '水晶城', '绿城春江明月', '滨江宝龙城市广场'],
    '长河': ['龙湖春江天玺', '绿城桂语江南', '融信保利创世纪'],
    '浦沿': ['晓风印月', '绿城晓风印月', '中海云宸'],
  },
  '余杭区': {
    '未来科技城': [
      '绿城西溪云庐', '融创金成未来海', '中南樾府', '阳光城未来悦MAX',
      '新湖果岭', '绿城翡翠城', '万科溪望', '中南樾府',
      '融创河滨之城', '合景天峻', '富力西溪悦居', '绿城桃李春风',
      '龙湖水晶郦城', '万科劝学里', '金成英特学府', '新城西溪逸境',
      '西溪蓝海', '华夏四季', '绿城桂语江南', '融信澜天',
      '中梁百悦城', '奥克斯缔逸城', '富力桃园', '万科良渚文化村',
      '和昌府', '德信海德公园', '越秀景瑞悦见山', '龙湖天钜',
      '阳光城翡丽海岸', '融信澜天', '万科杭宸', '新城香悦公馆',
      '融创金成臻蓝府', '绿城杨柳郡', '滨江御虹府', '融创云潮府',
    ],
    '云城': ['杭与城', '绿城云谷小镇', '万科天空之城', '融创城', '金成英特尔湾'],
    '良渚': ['万科良渚文化村', '绿城桂语江南', '融信澜天', '和昌府', '德信海德公园', '越秀景瑞悦见山', '龙湖天钜'],
    '闲林': ['融创金成未来海', '绿城翡翠城', '万科溪望', '西溪蓝海', '华元美林公馆'],
    '老余杭': ['融创金成臻蓝府', '中梁百悦城', '奥克斯缔逸城', '富力桃园'],
    '五常': ['绿城西溪诚园', '万科西庐', '绿城西溪融庄', '融创河滨之城', '中海西溪华府'],
    '勾庄': ['万科杭宸', '新城香悦公馆', '德信海德公园', '越秀星汇城'],
  },
  '临平区': {
    '临平新城': ['绿城玉园', '万科未来城', '融创玖樟台', '龙湖天曜', '绿城春风十里', '华元欢乐城'],
    '东湖新城': ['众安理想湾', '绿城蓝庭', '赞成首府', '万宝城'],
    '星桥': ['龙湖春江天玺', '融信澜天', '绿城桂语江南'],
    '乔司': ['万科未来城', '融创玖樟台', '绿城春风十里'],
  },
  '萧山区': {
    '奥体': ['绿城桂语江南', '融创江南壹号院', '保利东湾', '世茂之西湖', '滨江金茂府'],
    '亚运村': ['绿城桂冠东方', '华润亚奥城', '融创融望之城', '滨江翡翠江南'],
    '市北': ['龙湖春江天玺', '绿城桂语江南', '融信保利创世纪', '滨江御虹府'],
    '萧山科技城': ['融创江南壹号院', '保利东湾'],
    '新街': ['绿城桂语江南', '融信澜天'],
    '新塘': ['龙湖春江天玺', '融创玖樟台'],
    '大江东': ['融创城', '绿城桂语江南'],
