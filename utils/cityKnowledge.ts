...
export const hangzhouDistricts: Record<string, DistrictInfo> = {
  '上城区': {
    ...
    education: ['胜利实验学校', '天长小学', '建兰中学', '长江实验小学', '胜利小学'],
    priceLevel: 'S',
    priceTrend: 'stable',
  ...
  '拱墅区': {
    ...
    education: ['卖鱼桥小学', '文澜中学', '杭州第十四中学', '杭州市大关苑第一小学'],
    priceLevel: 'A',
    priceTrend: 'stable',
  ...
  '西湖区': {
    ...
    education: ['学军小学', '保俶塔实验学校', '西湖大学', '浙江大学紫金港校区', '杭州第二中学', '学军中学紫金港校区'],
    priceLevel: 'A',
    priceTrend: 'up',
  ...
  '滨江区': {
    ...
    education: ['江南实验学校', '杭二中白马湖学校', '长河小学', '浦沿小学'],
    priceLevel: 'S',
    priceTrend: 'up',
  ...
  '余杭区': {
    ...
    education: ['余杭第一中学', '天元公学', '杭师大附属学校', '杭师大附属中学', '学军中学紫金港校区'],
    priceLevel: 'A',
    priceTrend: 'up',
...
export const hangzhouBusinessDistricts: Record<string, { level: string; coefficient: number; basePrice: number }> = {
  ...
  // A级补充：主城区核心板块
  '近江': { level: 'A', coefficient: 1.12, basePrice: 50000 },
  '复兴': { level: 'B', coefficient: 1.08, basePrice: 42000 },
  '紫阳': { level: 'B', coefficient: 1.10, basePrice: 45000 },
  '凤起路': { level: 'A', coefficient: 1.15, basePrice: 55000 },
  '庆春路': { level: 'A', coefficient: 1.12, basePrice: 52000 },
  '闸弄口': { level: 'B', coefficient: 1.05, basePrice: 35000 },
  '四季青': { level: 'B', coefficient: 1.08, basePrice: 40000 },
  '九堡': { level: 'B', coefficient: 1.05, basePrice: 32000 },
  '黄龙': { level: 'A', coefficient: 1.18, basePrice: 58000 },
  '灵隐': { level: 'B', coefficient: 1.10, basePrice: 48000 },
  '植物园': { level: 'B', coefficient: 1.10, basePrice: 46000 },
  '曙光路': { level: 'B', coefficient: 1.08, basePrice: 44000 },
  '北山街': { level: 'B', coefficient: 1.10, basePrice: 45000 },
  '杨公堤': { level: 'B', coefficient: 1.08, basePrice: 44000 },
  '翠苑': { level: 'B', coefficient: 1.05, basePrice: 38000 },
  '古荡': { level: 'B', coefficient: 1.03, basePrice: 36000 },
  '城西银泰': { level: 'B', coefficient: 1.05, basePrice: 38000 },
  '大关': { level: 'B', coefficient: 1.05, basePrice: 35000 },
  '上塘': { level: 'B', coefficient: 1.03, basePrice: 33000 },
  '湖墅': { level: 'B', coefficient: 1.05, basePrice: 36000 },
  '半山': { level: 'C', coefficient: 1.00, basePrice: 28000 },
  '康桥': { level: 'C', coefficient: 0.98, basePrice: 25000 },
  '朝晖': { level: 'B', coefficient: 1.05, basePrice: 36000 },
  '文晖': { level: 'B', coefficient: 1.05, basePrice: 35000 },
  '长河': { level: 'B', coefficient: 1.08, basePrice: 40000 },
  '浦沿': { level: 'B', coefficient: 1.05, basePrice: 36000 },
  '城厢': { level: 'B', coefficient: 1.05, basePrice: 30000 },
  '北干': { level: 'B', coefficient: 1.05, basePrice: 30000 },
  '宁围': { level: 'B', coefficient: 1.03, basePrice: 28000 },
  '临平老城区': { level: 'B', coefficient: 1.03, basePrice: 26000 },
...
export const SCHOOLS: Record<string, SchoolInfo> = {
  ...
  '长江实验小学-primary': { name: '长江实验小学', type: 'primary', level: '优质', premium: 0.25 },
  ...
  '卖鱼桥小学-primary': { name: '卖鱼桥小学', type: 'primary', level: '顶尖', premium: 0.35 },
  '文澜小学-primary': { name: '文澜小学', type: 'primary', level: '优质', premium: 0.25 },
  // 初中
  ...
  '保俶塔实验学校-middle': { name: '保俶塔实验学校', type: 'middle', level: '优质', premium: 0.25 },
  '杭州第十四中学附属学校-middle': { name: '杭州第十四中学附属学校', type: 'middle', level: '优质', premium: 0.20 },
  // 高中
  ...
  '杭州第十四中学-high': { name: '杭州第十四中学', type: 'high', level: '优质', premium: 0.15 },
  '杭师大附属中学-high': { name: '杭师大附属中学', type: 'high', level: '优质', premium: 0.15 },
  '学军中学紫金港校区-high': { name: '学军中学紫金港校区', type: 'high', level: '顶尖', premium: 0.20 },
...
export const DISTRICT_BD_MAP: Record<string, string[]> = {
  '上城区': ['钱江新城', '湖滨', '望江', '南星桥', '城东新城', '艮北新城', '近江', '复兴', '紫阳', '凤起路', '庆春路', '武林', '闸弄口', '四季青', '九堡'],
  '拱墅区': ['武林', '运河新城', '祥符', '桃源', '申花', '大关', '上塘', '湖墅', '半山', '康桥', '朝晖', '文晖'],
  '西湖区': ['蒋村', '三墩', '黄龙', '灵隐', '植物园', '曙光路', '北山街', '杨公堤', '翠苑', '古荡', '城西银泰', '之江', '留下', '转塘'],
  '滨江区': ['滨江区政府', '物联网小镇'],
...
export const COMMUNITY_MAPPING: Record<string, Record<string, string[]>> = {
  '西湖区': {
    ...
    '黄龙': ['黄龙世纪雅苑', '求是村', '玉泉社区', '金沙港社区', '浙大求是小区', '黄龙洞社区', '栖霞岭社区'],
    '宝石山': ['宝石山下', '北山街社区', '葛岭路小区', '初阳台社区', '宝石山下四弄', '栖霞岭社区'],
    '植物园': ['植物园小区', '玉泉山居', '桃源岭小区', '灵峰山庄', '法云安缦周边'],
    '灵隐': ['灵隐社区', '白乐天社区', '飞来峰小区', '灵隐路小区', '天竺路社区'],
    '杨公堤': ['杨公堤小区', '花港观鱼社区', '浴鹄湾小区', '三台山路社区', '茅家埠社区'],
    '曙光路': ['曙光路社区', '黄龙体育中心周边', '求是路小区', '求是新村', '曙光花园'],
    '北山街': ['北山街社区', '葛岭小区', '宝石山下', '曲院风荷社区', '岳王路社区'],
    '翠苑': ['翠苑一区', '翠苑二区', '翠苑三区', '翠苑四区', '翠苑五区', '翠苑六区', '枫华府第'],
    '古荡': ['古荡小区', '古荡新村', '古荡东村', '文三西路小区', '益乐新村'],
    '城西银泰': ['城西银泰城', '丰潭路小区', '萍水路社区', '万家花城'],
  },
  '上城区': {
    ...
    '复兴': ['复兴南苑', '复兴北苑', '复兴东苑', '美政花苑', '水澄桥社区', '海月桥社区', '十奎巷社区'],
    '紫阳': ['紫阳社区', '太庙社区', '凤凰社区', '甬江社区', '彩霞岭社区', '木场巷社区'],
    '近江': ['近江家园', '近江六园', '近江七园', '近江八园', '钱江路小区', '衢江路小区', '四季青社区'],
    '凤起路': ['凤起路小区', '凤起都市花园', '青春坊', '新华路社区', '潮鸣寺巷', '东河沿社区'],
    '庆春路': ['庆春路小区', '庆春御府', '浙报公寓', '庆春苑', '大学路新村', '马市街社区'],
    '武林': ['武林路小区', '长寿桥社区', '凤麟社区', '竹竿巷社区', '仙林桥社区', '下焦营巷'],
    '闸弄口': ['闸弄口新村', '闸弄口东村', '机神社区', '天杭社区', '闻皇庙社区'],
    '四季青': ['四季青社区', '钱江苑', '三堡社区', '钱江新城区块'],
    '九堡': ['九堡社区', '格畈社区', '三卫社区', '蚕桑社区', '金海城'],
  },
  '拱墅区': {
    ...
    '东新': ['滨江万家星城', '世茂天宸', '东新园'],
    '大关': ['大关小区', '大关苑', '大关南苑', '大关北苑', '德胜小区', '大关路社区', '香积寺路社区'],
    '上塘': ['上塘镇小区', '上塘路社区', '拱宸桥东社区', '舟山东路社区', '蔡马社区'],
    '湖墅': ['湖墅新村', '湖墅路小区', '信义坊', '草营巷社区', '珠儿潭社区', '仓基新村'],
    '半山': ['半山社区', '半山田园', '半山国家森林公园周边', '建华社区', '杭钢南苑', '半山家园'],
    '康桥': ['康桥社区', '康桥村', '独城社区', '蒋家浜社区', '平安桥社区'],
    '朝晖': ['朝晖一区', '朝晖二区', '朝晖三区', '朝晖四区', '朝晖五区', '朝晖六区', '朝晖七区', '朝晖八区', '朝晖九区'],
    '文晖': ['文晖社区', '胜利社区', '打铁关社区', '和平小区', '现代城'],
  },
  '滨江区': {
    ...
    '长河': ['龙湖春江天玺', '绿城桂语江南', '融信保利创世纪', '春江彼岸', '长河社区', '长河高级中学周边', '白马湖社区', '天官塘社区', '长河小区', '长江小区', '长河路社区'],
    '浦沿': ['绿城晓风印月', '中海云宸', '绿城春来晴翠', '江荣府', '银爵世纪', '钱塘春晓花园', '中天官河锦庭', '浦沿社区', '浦沿新村', '新生社区', '东信社区', '杨家墩社区', '浦乐社区', '滨文社区'],
  ...
  '余杭区': {
    ...
    '临平老城区': ['临平老街', '邱山小区', '景山社区', '西大街社区', '北大街社区', '保障桥社区', '梅堰小区'],
  },
  '临平区': {
    '临平新城': ['绿城玉园', '万科未来城', '融创玖樟台', '龙湖天曜', '绿城春风十里', '华元欢乐城', '银泰城', '万宝城'],
    '东湖新城': ['滨杭滨纷城', '众安理想湾', '绿城蓝庭', '赞成首府', '万宝城', '嘉丰万悦城'],
    '星桥': ['龙湖春江天玺', '融信澜天', '绿城桂语江南', '广厦天都城', '香榭里', '天星苑'],
    '乔司': ['万科未来城', '融创玖樟台', '绿城春风十里', '华元欢乐城', '乔司社区', '三角村', '方桥村', '永和村', '乔司商贸城', '南苑社区'],
    '崇贤': ['星合映', '光合映', '群贤府', '金航府', '祥生群贤府', '旭辉时代城', '崇贤社区', '崇贤新城', '向阳社区', '大安村', '龙旋社区', '独山社区'],
    '仁和': ['仁和板块', '万科未来城'],
  },
  '萧山区': {
    ...
    '瓜沥': ['融创城'],
    '临浦': ['融创城'],
    '城厢': ['城厢社区', '西河路社区', '体育路社区', '育才社区', '回澜南苑', '回澜北苑', '崇化社区'],
    '北干': ['北干社区', '北干一苑', '北干二苑', '荣星社区', '柳桥社区', '华达社区', '永久社区'],
    '宁围': ['宁围社区', '宁安社区', '丰东社区', '盈一社区', '顺坝社区', '宁税社区'],
    '开发区': ['开发区社区', '市北区块', '桥南区块', '桥北区块', '鸿兴路社区'],
  },
};
...
export const DEFECT_COMMUNITIES: Record<string, DefectCommunityInfo> = {
  ...
  '广厦天都城': {
    ...
    businessDistrict: '星桥',
    defects: ['地势低洼易涝'],
    source: '星桥板块地势偏低，周边河道排水能力不足，暴雨天易积水',
    level: 'high',
  },
  '广厦天都城爱丽山庄': {
    district: '临平区',
    businessDistrict: '星桥',
    defects: ['地势低洼易涝'],
    source: '星桥板块低洼地带，2020年梅汛期间多栋底层被淹',
    level: 'high',
  },
  '杭钢南苑': {
    district: '拱墅区',
    businessDistrict: '半山',
    defects: ['工厂污染'],
    source: '半山钢铁厂旧址周边，土壤重金属残留风险，曾有环境修复报道',
    level: 'medium',
  },
  '半山家园': {
    district: '拱墅区',
  ...
  '浦沿社区老小区': {
    ...
    businessDistrict: '浦沿',
    defects: ['垃圾处理站'],
    source: '浦沿板块垃圾中转站，夏季异味明显，影响周边500米范围',
    level: 'medium',
  },
  '之江家园': {
    district: '西湖区',
    businessDistrict: '之江',
    defects: ['地势低洼易涝'],
    source: '之江板块沿江低洼地带，钱塘江潮汛期间排水压力大',
    level: 'medium',
  },
  '银泰城附近安置房': {
    district: '上城区',
    businessDistrict: '城东新城',
    defects: ['主干道噪音'],
    source: '银泰城周边多处在建工地，施工噪音和扬尘影响，夜间施工频繁',
    level: 'medium',
  },
  '钱江苑': {
    district: '上城区',
